# Audit typographie FR (espaces insécables) — 2026-07-05 06:43
...
| `menuisier-dunkerque.html` | **12** | `…es, panneaux PVC, parquet : nos menuisiers HELP Conf…` · `…lle Indép. 👋 Porte abîmée ? Panneau cassé ? On envoi…` · `…te abîmée ? Panneau cassé ? On envoie notre menuisie…` |
| `pmr-dunkerque.html` | **12** | `…monte-escalier, accès PMR : nos artisans labellisés…` · `…e Indép. 👋 Adaptation PMR ? Salle de bain, douche it…` · `…de bain, douche italienne ? On vous accompagne de A…` |
| `serrurier-calais.html` | **12** | `…age, cylindre de sécurité : nos serruriers HELP Conf…` · `…le Indép. 👋 Porte claquée ? Clé cassée ? Un serrurie…` · `…orte claquée ? Clé cassée ? Un serrurier intervient…` |
| `serrurier-dunkerque.html` | **12** | `…age, cylindre de sécurité : nos serruriers HELP Conf…` · `…le Indép. 👋 Porte claquée ? Clé cassée ? Un serrurie…` · `…orte claquée ? Clé cassée ? Un serrurier intervient…` |
| `vitrier-dunkerque.html` | **12** | `…é, fissure, bris de glace : nos vitriers HELP Confor…` · `…le Indép. 👋 Bris de glace ? Double vitrage à remplac…` · `…ouble vitrage à remplacer ? On envoie notre vitrier.…` |
...
| `volets-dunkerque.html` | **11** | `…isation, dépannage moteur : nos techniciens HELP Con…` · `…lle Indép. 👋 Volet bloqué ? Tablier cassé, moteur en…` · `…er cassé, moteur en panne ? On envoie notre spéciali…` |
...
| `electricien-boulogne-sur-mer.html` | **10** | `…en sécurité, installation : nos électriciens HELP Co…` · `…dép. 👋 Coupure de courant ? Tableau qui saute ? J'en…` · `…urant ? Tableau qui saute ? J'envoie un électricien.…` |
...
| `plombier-calais.html` | **10** | `…erche de fuite, sanitaire : nos plombiers HELP Confo…` · `…tville Indép. 👋 Une fuite ? Un dégorgement ? On envo…` · `…ne fuite ? Un dégorgement ? On envoie notre spéciali…` |
...
| `chauffagiste-dunkerque.html` | **9** | `…etien annuel, désembouage : nos chauffagistes HELP C…` · `…dép. 👋 Chaudière en panne ? Plus d'eau chaude ? Je v…` · `…panne ? Plus d'eau chaude ? Je vous mets en relation…` |
...
| `menuisier-saint-omer.html` | **9** | `…sur-mesure, sécurisation : nos vitriers intervienne…` · `…lle Indép. 👋 Porte abîmée ? Panneau cassé ? On envoi…` · `…te abîmée ? Panneau cassé ? On envoie notre menuisie…` |
| `plombier-boulogne-sur-mer.html` | **9** | `…erche de fuite, sanitaire : nos plombiers HELP Confo…` · `…tville Indép. 👋 Une fuite ? Un dégorgement ? On envo…` · `…ne fuite ? Un dégorgement ? On envoie notre spéciali…` |
| `plombier-dunkerque.html` | **9** | `…erche de fuite, sanitaire : nos techniciens HELP Con…` · `…tville Indép. 👋 Une fuite ? Un dégorgement ? On envo…` · `…ne fuite ? Un dégorgement ? On envoie notre spéciali…` |
...
| `chauffagiste-saint-omer.html` | **8** | `…retien annuel obligatoire : nos chauffagistes interv…` · `…dép. 👋 Chaudière en panne ? Plus d'eau chaude ? Je v…` · `…panne ? Plus d'eau chaude ? Je vous mets en relation…` |
...
| `electricien-saint-omer.html` | **8** | `…se aux normes NF C 15-100 : nos électriciens qualifi…` · `…dép. 👋 Coupure de courant ? Tableau qui saute ? J'en…` · `…urant ? Tableau qui saute ? J'envoie un électricien.…` |
| `pmr-saint-omer.html` | **8** | `…PMR, élargissement portes : nos équipes adaptent vot…` · `…e Indép. 👋 Adaptation PMR ? Salle de bain, douche it…` · `…de bain, douche italienne ? On vous accompagne de A…` |
| `serrurier-saint-omer.html` | **8** | `…cée, clé cassée, blindage : nos serruriers intervien…` · `…le Indép. 👋 Porte claquée ? Clé cassée ? Un serrurie…` · `…orte claquée ? Clé cassée ? Un serrurier intervient…` |
| `vitrier-saint-omer.html` | **8** | `…sur-mesure, sécurisation : nos vitriers intervienne…` · `…le Indép. 👋 Bris de glace ? Double vitrage à remplac…` · `…ouble vitrage à remplacer ? On envoie notre vitrier.…` |
| `volets-saint-omer.html` | **8** | `…tablier cassé, pose neuve : nos techniciens intervie…` · `…lle Indép. 👋 Volet bloqué ? Tablier cassé, moteur en…` · `…er cassé, moteur en panne ? On envoie notre spéciali…` |
...
| `plombier-saint-omer.html` | **7** | `…erche de fuite, sanitaire : nos techniciens intervie…` · `…tville Indép. 👋 Une fuite ? Un dégorgement ? On envo…` · `…ne fuite ? Un dégorgement ? On envoie notre spéciali…` |
