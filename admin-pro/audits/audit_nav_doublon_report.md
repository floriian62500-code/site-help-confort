...
_Généré le 2026-05-15 18:49_

- Source nav : `index.html` (nav.hc-nav détectée)
- Liens internes uniques scannés : **13**
- Pages cibles lues : **13**
...
dont les `<h1>` (ou H1+meta-description) ont une similarité Jaccard 
supérieure aux seuils, le funnel utilisateur est confus et le 
référencement risque la cannibalisation (Google ne sait pas laquelle 
ranker).

## ✅ Aucun doublon détecté dans la nav principale
...
- ✓ `guide-adaptation-pmr.html` — « Adaptation PMR »
