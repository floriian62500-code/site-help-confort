...
*Généré le 2026-08-25 03:50 — `admin-pro/audits/audit_liens_externes.py`*
...
| 403 | `https://www.legrand.fr/` | partenaires.html | Forbidden |
| --- | `https://www.meister.com/fr` | partenaires.html | URLError: <urlopen error timed out> |
| --- | `https://www.service-public.fr/particuliers/vosdroits/F19905` | aides.html | URLError: <urlopen error timed out> |

## 📊 Statistiques

- Taux de succès : **78 %** (48/61)
