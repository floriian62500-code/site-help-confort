...
- [ ] **FAQPage doublonnée sur 5 pages métier** — fusionner HC-FAQ-SCHEMA-V1 (top) avec FAQ bottom en 1 seul JSON-LD synchro avec les `<details>` HTML (cf. bugs #35-36 MEMOIRE). Concerne plombier/électricien/serrurier/chauffagiste/travaux-saint-omer.html.
