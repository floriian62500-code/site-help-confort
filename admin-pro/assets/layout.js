  ...
  const SECTIONS = [
    { id:'activity', label:'Mon activité', module:'comm',
      ...
      links: [
        ...
        // HC-FIX 2026-05-20 : Avis Google gérés dans le CRM externe Apogée, retirés du back-office
        // (cf. memory project_crm_passerelle : interventions+contrats+avis = CRM externe)
