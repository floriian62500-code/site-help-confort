...
| A22 | pages métiers — cartes savoir-faire | UX/Nav/SEO | Cartes → catalogue générique nos-prestations#sec-*, MAIS les pages sous-métier dédiées **existent déjà** dans prestations/ (porte-entree, porte-garage, fenetres, portail-cloture, coulissant-baie-vitree, parquet, garde-corps-rampes, remplacement-panneau-porte). Vrai fix = **rebrancher**, pas créer. | P1 | **Menuiserie fait** : 8 cartes rebranchées vers prestations/*.html (menuisier SO+DK) ; doublon /porte-entree.html créé par erreur puis retiré ; A17 comblé sur prestations/ (35 pages apex). Autres métiers : même méthode. | ✅ 8 cibles 200 + cohérentes (H1 / canonical apex / form lead) · carte menuiserie-cards au centre | ✅ | ⏳ | — | — |
