...
| A14 | nos-prestations « Voir le tarif » | **Revenu** | Lead-gate créait un lead **parallèle** (`contracts`), sans form_type, sans prestation/prix, sans notif, sans anti-doublon | **P1** | Branché sur **submit-lead-v6** : `form_type=tarif_prestation`, prestation/slug/métier/prix/ville/CP/agence(CP)/source_page, anti-doublon (localStorage 30min), tracking (5 events), RGPD reformulé | ✅ **E2E→DB PASS** : 1 lead (0 doublon), utm complet, test archivé/silencieux, nettoyé | ✅ | ⏳ | — | — |
