...
| A22 | pages métiers — cartes savoir-faire | UX/Nav/SEO | Les cartes pointaient vers le catalogue générique  — MAIS les pages sous-métier dédiées **existent déjà** dans  (porte-entree, porte-garage, fenetres, portail…). Vrai fix = **rebrancher**, pas créer | P1 | **Menuiserie** : 8 cartes rebranchées vers  (2 pages menuisier) ; doublon  créé par erreur puis retiré ; A17 comblé sur  (35 pages apex). Autres métiers : même méthode (rebrancher l'existant) | ✅ 8 cibles 200 + cohérentes (H1/canonical apex/form) | ✅ | ⏳ (carte  au centre) | — | — |
