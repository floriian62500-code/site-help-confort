...
| CMD-8 | 5444294942/5444326310 | P0 | Refonte visuelle 2026 (rendu refusé : daté/vide/emoji) — cartes d'intention modernes SVG, réassurance, urgence intégrée, callback expandable, vides réduits | **READY_FOR_QA** | `24425d85` | Visual QA navigateur (launcher + home vus) + geometry 1440/390, 0 erreur console, routes inchangées | home `#hc-reservation` + launcher `/catalogue` redesignés (SVG, profondeur, hover/focus, prefers-reduced-motion) | validation visuelle finale Florian |
