...
Sandbox isolée, aucun effet sur le repo réel. **Résultat (préflight+postflight) : 18 PASS / 0 FAIL.**
...
**Tests : 18/18 PASS** (7 préflight + 11 postflight) — `scripts/control/runner-preflight.test.sh`.
