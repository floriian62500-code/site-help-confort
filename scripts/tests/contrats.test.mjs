...
ok('souscription mobile : boutons de l’assistant dans l’écran (en 390, « Suivant » sortait de 18 px et « Envoyer ma demande » de 82 px)', /@media \(max-width:560px\)\{\.sw-nav\{flex-wrap:wrap;gap:10px\}\.sw-step-counter\{order:-1;flex:1 0 100%\}\.sw-btn-next,\.sw-btn-submit\{flex:1;justify-content:center\}\}/.test(h));
