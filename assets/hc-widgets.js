...
(function() {
  ...
  style.textContent = "" +
    ...
    ".hc-fab-bubble{position:absolute;bottom:170px;right:8px;z-index:6;background:#fff;color:#0A1428;padding:11px 18px;border-radius:18px 18px 4px 18px;box-shadow:0 14px 32px rgba(13,160,207,.22),0 2px 6px rgba(10,20,40,.08);font-size:.92rem;font-weight:700;max-width:260px;white-space:nowrap;animation:hcBubbleFloat 5s ease-in-out infinite,hcBubbleEnter .5s ease-out;cursor:default;border:1.5px solid rgba(13,160,207,.18)}" +
    ".hc-fab-bubble .hcfb-text{color:#0A1428;letter-spacing:-.005em}" +
    ".hc-fab-bubble::after{content:'';position:absolute;bottom:-7px;right:18px;width:14px;height:14px;background:#fff;border-right:1px solid rgba(13,160,207,.12);border-bottom:1px solid rgba(13,160,207,.12);transform:rotate(45deg)}" +
  ...
  fab.innerHTML =
    ...
    "<button type='button' class='hc-fab-btn hc-fab-btn--premium' aria-label='Ouvrir le menu HELP! Confort' aria-expanded='false'>" +
      ...
      "<img class='hc-fab-masc' src='mascotte.png' alt='' onerror=\"this.style.display='none';this.nextElementSibling.style.display=''\" loading='lazy'>" +
